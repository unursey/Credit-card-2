...
(0, _initJs.init)(); // const name = document.getElementById('name');
...
},{"./modules/init.js":"jreEZ"}],"jreEZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "init", ()=>init);
var _createPageJs = require("./createPage.js");
const init = ()=>{
    (0, _createPageJs.createPage)();
};

},{"./createPage.js":"4ybhX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4ybhX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _searchCardJs = require("./searchCard.js");
const createPage = ()=>{
    const divTitle = (0, _redom.el)("div", {
        className: "payment-title"
    }, (0, _redom.el)("h1", "Payment Information"));
    const divContainer = (0, _redom.el)("div", {
        className: "container"
    }, (0, _redom.el)("div", {
        ...
        "card number"
    ]), (0, _redom.svg)("g", (0, _redom.svg)("text", [
        {
    ...
    })), (0, _redom.svg)("g", (0, _redom.svg)("g", (0, _redom.svg)("rect", {
        x: "82",
        y: "70",
        className: "st12",
        width: "1.5",
        ...
        class: "st9 st6 st10"
    }, "security code")), (0, _redom.svg)("rect", {
        x: "58.1",
        y: "378.6",
        class: "st11",
        width: "375.5",
    ...
    const divFormContainer = (0, _redom.el)("div", {
        ...
        oninput (e) {
            e.preventDefault();
            (0, _validJs.numberCard)(e);
            (0, _searchCardJs.searchCard)(e);
        }
    }), (0, _redom.svg)("svg", {
        id: "ccicon",
        class: "ccicon",
    ...
    (0, _controlJs.message)();
    (0, _controlJs.foo)(document.getElementById("svgname"), document.getElementById("name"));
    (0, _controlJs.foo)(document.getElementById("svgnumber"), document.getElementById("cardnumber"));
    (0, _controlJs.foo)(document.getElementById("svgexpire"), document.getElementById("expirationdate"));
    (0, _controlJs.foo)(document.getElementById("svgsecurity"), document.getElementById("securitycode"));
    (0, _controlJs.foo)(document.getElementById("svgnameback"), document.getElementById("name"));
};

},{"redom":"iahd6","./control.js":"zfhsF","./valid.js":"9JqDA","./searchCard.js":"8VT1Z","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iahd6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"zfhsF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "swapColor", ()=>swapColor);
...
const message = ()=>{
    ...
    const cliclHandler = ()=>{
        if ((0, _valid.nameCardTest)(cardName.value) && (0, _valid.numberCardTest)(cardNumber.value) && (0, _valid.codeCardTest)(securitycode.value)) sendMessage.textContent = "Данные введены верно";
...
},{"./valid":"9JqDA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9JqDA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "codeCard", ()=>codeCard);
parcelHelpers.export(exports, "nameCard", ()=>nameCard);
parcelHelpers.export(exports, "numberCard", ()=>numberCard);
parcelHelpers.export(exports, "dateCard", ()=>dateCard);
parcelHelpers.export(exports, "codeCardTest", ()=>codeCardTest);
parcelHelpers.export(exports, "nameCardTest", ()=>nameCardTest);
parcelHelpers.export(exports, "numberCardTest", ()=>numberCardTest);
const codeCard = (e, count)=>{
    e.target.value = e.target.value.replace(/\D/g, "").substr(0, count);
};
const nameCard = (e)=>{
    e.target.value = e.target.value.charAt(0).toUpperCase() + e.target.value.slice(1);
    e.target.value = e.target.value.replace(/^ +|[^A-Za-z ]/g, "").replace(/ +(\w*).*/, " $1");
};
const numberCard = (e)=>{
    let cardCode = e.target.value.replace(/\D/g, "").substring(0, 16);
    if (cardCode.length == 15) cardCode = cardCode.substr(0, 4) + " " + cardCode.substr(4, 6) + " " + cardCode.substr(10, 5);
...
const codeCardTest = (codeCard)=>{
    const code = /^\d{3}$/.test(codeCard);
    if (code) return true;
    else return false;
};
const nameCardTest = (nameCard)=>{
    nameCard = nameCard.replace(/\s+/g, " ").trim();
    const nameArr = nameCard.split(" ");
    if (nameArr.length === 2 && /^[A-Z]*$/i.test(nameCard.replace(/\s/g, ""))) return true;
    else return false;
};
const numberCardTest = (numberCard)=>{
    const num = numberCard.replace(/\s/g, "");
    if (/^\d{16}$/.test(num) || /^\d{15}$/.test(num)) return true;
    else return false;
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8VT1Z":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "searchCard", ()=>searchCard);
...
const searchCard = (e)=>{
    ...
    (0, _control.swapColor)("grey");
    ccicon.innerHTML = "";
    cclogo.innerHTML = "";
    mask.forEach((i)=>{
        if (e.target.value.replace(/[0-9]/g, "0") === i.mask && RegExp(i.regex).test(e.target.value) && i.regex) {
            (0, _control.swapColor)(i.color);
            ccicon.innerHTML = i.icon;
            cclogo.innerHTML = i.logo;
        }
    });
};

},{"./control":"zfhsF","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hfQGK","83FZ8"], "83FZ8", "parcelRequire7fc0")
